...
import { CONTROLS_HEIGHT, GAME_BAR_HEIGHT, RIGHT_DRAWER_BUTTON_WIDTH, RIGHT_DRAWER_WIDTH, STREAM_ASPECT_RATIO_W_H } from "../constants"
...
export const DimensionContainer = createContainer(() => {
    ...
    useEffect(() => {
        ...
        const streamWidth = mainDivWidth - RIGHT_DRAWER_BUTTON_WIDTH * pxToRemRatio - rightDrawerAllowance - LEFT_DRAWER_WIDTH * pxToRemRatio

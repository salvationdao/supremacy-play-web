        ...
        >
            <Stack sx={{ m: "1rem", width: "25rem" }}>
                <Box sx={{ width: "100%", height: "22rem", mb: "1rem" }}>
                    <MediaPreview
                        imageUrl={item?.imageUrl || "https://afiles.ninja-cdn.com/passport/genesis/avatar/zaibatsu_tenshi-mk1_white-gold-pattern_avatar.png"}
                        videoUrls={[item?.animationUrl]}
                        objectFit="cover"
                    />
                </Box>
    ...
    return (
        <Stack direction="row" spacing="1rem">
            <Box sx={{ width: "6rem", height: "6rem", flexShrink: 0 }}>
                <MediaPreview
                    imageUrl={item?.avatarUrl || "https://afiles.ninja-cdn.com/passport/genesis/avatar/zaibatsu_tenshi-mk1_white-gold-pattern_avatar.png"}
                    videoUrls={[item?.animationUrl]}
                    showBorder
                />
            </Box>

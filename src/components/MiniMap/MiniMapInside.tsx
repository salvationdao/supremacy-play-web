...
export const MiniMapInside = ({ containerDimensions }: MiniMapInsideProps) => {
    const { map } = useGame()
    const { mapElement, gridWidth, gridHeight, isTargeting, selection, setSelection, playerAbility, winner, setHighlightedMechHash } = useMiniMap()
            ...
            <>
                ...
                >
                    ...
                    >
                        ...
                        <Box
                            ref={mapElement}
                            onClick={isLocationSelection ? onMapClick : () => setHighlightedMechHash(undefined)}
                            sx={{
                                position: "absolute",
                                width: `${map.width}px`,

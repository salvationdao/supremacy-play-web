import { Box, Checkbox, Stack, SxProps } from "@mui/material"
            ...
            <Stack spacing="1.2rem" sx={{ overflow: "hidden" }}>
                <Stack direction="row" spacing="1.2rem">
                    ...
                    >
                        ...
                        {/* Hover eye */}
                        <NiceTooltip placement="left" renderNode={<MechTooltipRender mech={mech} />} color={ownerFaction.palette.primary}>
                            <Box
                                sx={{
                                    position: "absolute",
                                    top: ".3rem",

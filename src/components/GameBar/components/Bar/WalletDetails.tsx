...
export const WalletDetails = ({ tokenSalePage }: { tokenSalePage: string }) => {
	...
	const [supsMultipliers, setSupsMultipliers] = useState<Map<string, SupsMultiplier>>(new Map<string, SupsMultiplier>())
			...
			>
				...
				>
					<Tooltip
						...
						title={<SupsToolTipContent sups={sups} supsMultipliers={supsMultipliers} selfDestroyed={selfDestroyed} />}
						componentsProps={{
				...
				<Divider orientation="vertical" flexItem sx={{ height: 23, my: "auto !important", ml: 3, borderColor: colors.darkGrey, borderRightWidth: 1.6 }} />
			</Stack>
		</BarExpandable>
	)
}
...
const MultiplierItem = ({ supsMultiplier, selfDestroyed }: { supsMultiplier: SupsMultiplier; selfDestroyed: (key: string) => void }) => {
	...
	return (
		<Stack direction="row" alignItems="center" spacing={2}>
			...
			<Stack alignItems="center" justifyContent="center" sx={{ minWidth: 50, alignSelf: "stretch", background: "#00000075", borderRadius: 1 }}>
				<Typography sx={{ fontFamily: "Share Tech", textAlign: "center", lineHeight: 1, color: "grey !important" }} variant="caption">
